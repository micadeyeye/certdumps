...
?>&nbsp;&nbsp;&nbsp;</td>
 ...
 <img src="oth_images/contactus.gif" alt="" name="disclaimer" width="126" height="15" border="0">
 <br>          
            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top">ADEYEYE OLUWASEGUN M.(CIW Professional),<br>
                  <strong>Cellphone:</strong> 08030677907<br>
                  <strong>E-mail:</strong> micadeyeye@yahoo.com,<br>
                sales@ngportal.com<br>                  </td>
                <td valign="top">ADEYEMO OLUWAFEMI S.(CCNP, ITIL, MCP),<br>
                  <strong>Cellphone:</strong> +46762913415 <br>
                  <strong>E-mail:</strong> femsoft1@yahoo.com <br>
                  <strong>Yahoo messenger: </strong> feasysoft </td>
              </tr>
			  <tr>
			 
			    <td width="30%"><strong>Yahoo Group:</strong> <a href="http://groups.yahoo.com/group/ngportal" target="_blank">http://groups.yahoo.com/group/ngportal</a><br>
			      <strong>Yahoo messenger: </strong>adeyeyemichael<br>
			    <strong>Website:</strong> <a href="http://www.ngportal.com">http://www.ngportal.com</a></td>
				 <td width="70%">
			  OJEWALE OLUWASEGUN(SCJP, SCSA, ITIL, OCA, MCP),<br>
                  <strong>Cellphone:</strong> 08032008185 <br>
                  <strong>E-mail:</strong> shegoj@yahoo.com <br>
                  <strong>Yahoo messenger: </strong> shegoj 
			  
			  </td>
			  </tr>
            </table><hr width="100%" size="1" noshade>
			<table  border="0" cellspacing="0" cellpadding="0">
			  <form action="<?php echo $_SERVER['PHP_SELF'];?>"  method="post">
  <tr>
    <td><strong>Instant Messaging - </strong>
      <?php
...
mail('sales@ngportal.com','MESSAGE FROM CERTDUMPS',"'E-mail address:"
.$emailaddress.",\nSent message:"
.$message."'");
echo "<font color='#ff3333'>Message Sent</font>";
          }

?></td>
  </tr>
  <tr>
    <td>E-mail address:-&nbsp;&nbsp;&nbsp;<input name="mailadd" type="text" id="mailadd" size="34"></td>
  </tr>
  <tr>
    <td valign="top">Message details:&nbsp;&nbsp;
      <textarea name="message" cols="27" rows="4" id="message"></textarea></td>
  </tr>
  <tr><td align="center"><input name="submit" type="submit" value="Send"></td></tr></form>
</table>
</td>
        </tr>
    </table></td>
