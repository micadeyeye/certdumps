...
<title>.:::Certdumps:::.Microsoft, Cisco, Comptia, Oracle, CIW, A+, BRAINDUMPS - MCSE, CCNA, Windows 2003, A+ tests.</title>
...
?>&nbsp;&nbsp;&nbsp;</td>
  ...
  <tr>
    ...
    <td width="570" rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbtext">
        <!--DWLayoutTable-->
        
        <tr>
          <td height="168" valign="top">  <img name="disclaimer" src="oth_images/disclaimer.gif" border="0" alt=""><p>
     
		  
While Certdumps makes every effort to present accurate and reliable information on this Internet site, Certdumps does not endorse, approve or certify such information, nor does it guarantee the accuracy, completeness, efficacy, timeliness or correct sequencing of such information. Use of such information is voluntary and reliance on it should only be undertaken after an independent review of its accuracy, completeness, efficacy and timeliness. Reference herein to any specific commercial product, process or service by trade name, trademark, service mark, manufacturer or otherwise does not constitute or imply endorsement, recommendation or favoring by Certdumps .Certdumps Website does not solicit nor accepts copyright Material, nor any material pertaining to any type of certifications. Certdumps (including its employees and agents) assumes no responsibility for consequences resulting from the use of the information herein, or in any respect for the content of such information, including (but not limited to) errors or omission, the accuracy or reasonableness of factual or scientific assumptions, studies or conclusions, the defamatory nature of statements, ownership of copyright or other intellectual property rights and the violation of property, privacy or personal rights of others. Certdumps is not responsible for, and expressly disclaims all liability for, damages of any kind arising out of use, reference to or reliance on such information. No guarantees or warranties, including to (but not limited to) any express or implied warranties of merchantability or fitness for any particular use or purpose, are made by Certdumps with respect to such information.</P> 
  ...
  <tr>
    ...
    <td valign="bottom"><table width="100%" border="0" cellpadding="2" cellspacing="0" class="tbtext">
      <tr>
        <td valign="bottom">  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="disclaimer.php">Disclaimer</a> | <a href="contact.php">Contact Us</a>  | <a href="../it-books+/login.php?logout=true">Visit IT-Books+</a>         <p>©2005 Designed and maintained by Asmic Computers (Nig.) Co.</p></td>
      </tr>
    </table> 
    </td>
  </tr>
